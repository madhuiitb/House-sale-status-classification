...
# #_____________________________________________________________________________
with open('finalModel1.pkl', 'rb') as model3:  		 # Reading bytes from finalmodel file which was written by Random Forest Classifier
...
# #_____________________________________________________________________________
with open('finalModel2.pkl', 'rb') as model5:  		 # Reading bytes from finalmodel file which was written by Support Vector Machines Classifier
